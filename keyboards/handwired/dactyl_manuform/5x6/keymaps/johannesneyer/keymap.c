...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT_5x6(
    ...
    KC_LCPO, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,            KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RCPC,
                      KC_LEFT, KC_RIGHT,                                            KC_DOWN, KC_UP,
                                        ...
                                        KC_TAB,  KC_LGUI,         KC_LCTRL,KC_BSPC,
                                        KC_LALT, NUM,             _______, KC_RALT
  ),
  [_LOWER] = LAYOUT_5x6(
    KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,         KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, _______,
    KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,         KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_DEL,
    KC_DEL,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,           KC_F6,   KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE,
    KC_LCBR, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,          KC_F12,  _______, KC_HOME, KC_END,  _______, KC_RCBR,
  ...
  [_RAISE] = LAYOUT_5x6(
    ...
    KC_LBRC, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,          KC_F12,  _______, KC_PGUP, KC_PGDN, _______, KC_RBRC,
                      _______, _______,                                             _______, _______,
                                        _______, _______,         _______, _______,
                                        _______, _______,         _______, _______,
